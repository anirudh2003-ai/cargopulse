...
--   active severe share       15
--   active delay intensity    10
--   trailing utilisation      15
--   vessel backlog            10
--
-- ============================================================
...
DROP MATERIALIZED VIEW IF EXISTS
    public.lng_terminal_risk_score_daily;
...
WITH normalised AS (
    ...
    FROM public.lng_terminal_risk_features_daily
        AS features
),
...
CREATE UNIQUE INDEX
idx_lng_terminal_risk_score_date

ON public.lng_terminal_risk_score_daily (
    metric_date
);


CREATE INDEX
idx_lng_terminal_risk_score_level
...
ANALYZE public.lng_terminal_risk_score_daily;
