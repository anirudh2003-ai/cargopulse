...
DROP MATERIALIZED VIEW IF EXISTS
    public.lng_terminal_risk_explanations_daily;
...
WITH base AS (
    ...
    FROM public.lng_terminal_risk_score_daily
),
...
CREATE UNIQUE INDEX
idx_lng_terminal_risk_explanations_date

ON public.lng_terminal_risk_explanations_daily (
    metric_date
);


ANALYZE public.lng_terminal_risk_explanations_daily;
